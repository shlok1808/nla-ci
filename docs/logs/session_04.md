...
1. Build `scripts/diff_of_means.py` — compute difference vector, feed to NLA, read description
2. Based on result: either proceed with scoring (if CI language appears) or pivot to Idea 2 / Fable review
3. Use Fable to review full methodology before building analysis
